...
static struct gamma_curvy gamma_tbl = {
	.gamma_len = 33,
	.bl_len = 8,
	.ref_y_gamma = {0, 2, 3, 5, 11, 18, 30, 45, 62, 75, 95, 115, 139, 168,
			 194, 224, 259, 304, 340, 379, 422, 466, 512, 562, 611,
			 662, 726, 778, 840, 892, 953, 1009, 1024},
	...
	.ref_bl_lvl = {0, 33, 165, 297, 429, 623, 821, 1024},
	.ref_y_lvl = {0, 39, 177, 318, 446, 637, 840, 1024},
};
